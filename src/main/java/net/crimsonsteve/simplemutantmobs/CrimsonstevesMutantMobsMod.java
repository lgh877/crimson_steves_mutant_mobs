...
@Mod("crimsonsteves_mutant_mobs")
public class CrimsonstevesMutantMobsMod {
	public static final Logger LOGGER = LogManager.getLogger(CrimsonstevesMutantMobsMod.class);
	public static final String MODID = "crimsonsteves_mutant_mobs";

	public CrimsonstevesMutantMobsMod() {
