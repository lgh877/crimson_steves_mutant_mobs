...
public class MutantSkeletonModel extends AnimatedGeoModel<MutantSkeletonEntity> {
	...
	public void setCustomAnimations(MutantSkeletonEntity animatable, int instanceId, AnimationEvent animationEvent) {
		...
		if (animatable.hurtTime > 0) {
			...
			//value = 1 - value;
			lowerBody.setRotationX(lowerBody.getRotationX() + (float) (value * hurtVec.z() / 5));
			lowerBody.setRotationZ(lowerBody.getRotationZ() - (float) (value * hurtVec.x() / 5));
			upperBody.setRotationX(upperBody.getRotationX() + (float) (value * hurtVec.z() / 5));
			upperBody.setRotationZ(upperBody.getRotationZ() - (float) (value * hurtVec.x() / 5));
