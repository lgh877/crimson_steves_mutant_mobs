...
public class HopkeletonModel extends AnimatedGeoModel<HopkeletonEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(HopkeletonEntity animatable, int instanceId, AnimationEvent animationEvent) {
